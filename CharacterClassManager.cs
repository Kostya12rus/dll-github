...
public class CharacterClassManager : NetworkBehaviour
{
  ...
  private void Start()
  {
    ...
    this._lureSpj = Object.FindObjectOfType<LureSubjectContainer>();
    this._scp049 = this.GetComponent<Scp049PlayerScript>();
    this._scp0492 = this.GetComponent<Scp049_2PlayerScript>();
    this._scp079 = this.GetComponent<Scp079PlayerScript>();
    this._scp106 = this.GetComponent<Scp106PlayerScript>();
    this._scp173 = this.GetComponent<Scp173PlayerScript>();
    this._scp096 = this.GetComponent<Scp096PlayerScript>();
    this._scp939 = this.GetComponent<Scp939PlayerScript>();
    ...
    if (this.isLocalPlayer)
    {
      ...
      {
        GameConsole.Console.singleton.AddLog("Steam not initialized - sending empty auth token.\nIf server is using online mode, you will probably get kicked.", (Color32) Color.red, false);
  ...
  private void Update()
  {
    if (this.curClass == 2)
      ...
      this._aliveTime += Time.deltaTime;
    if (this.isLocalPlayer)
    {
  ...
  public void TargetConsolePrint(NetworkConnection connection, string text, string color)
  {
    ...
    color1 = Color.grey;
label_13:
    GameConsole.Console.singleton.AddLog("[MESSAGE FROM SERVER] " + text, (Color32) color1, false);
  }
  ...
  private IEnumerator Init()
  {
    ...
    return (IEnumerator) new CharacterClassManager.\u003CInit\u003Ec__Iterator0() { \u0024this = this };
  }
  ...
  {
    if (this.GetComponent<ServerRoles>().RemoteAdmin || this.GetComponent<ServerRoles>().Staff)
      this.CallTargetConsolePrint(this.connectionToClient, "Contact email address: " + ConfigFile.ServerConfig.GetString("contact_email", string.Empty), "green");
    else
      this.CallTargetConsolePrint(this.connectionToClient, "You don't have permissions to execute this command.", "red");
  }
  ...
  public void CmdRequestServerGroups()
  {
    ...
    this.CallTargetConsolePrint(this.connectionToClient, "Defined groups on server " + str, "grey");
  }

  [Command(channel = 2)]
  public void CmdRequestHideTag()
  {
    ServerRoles component = this.GetComponent<ServerRoles>();
    ...
    this.CallTargetConsolePrint(this.connectionToClient, "Badge hidden.", "green");
  }
  ...
  public void CmdRequestShowTag(bool global)
  {
    ...
    if (global)
    {
      ...
      {
        this.CallTargetConsolePrint(this.connectionToClient, "You don't have global tag.", "magenta");
      }
      else
      {
        ...
        this.CallTargetConsolePrint(this.connectionToClient, "Global tag refreshed.", "green");
      }
    }
    else
    {
      ...
      this.CallTargetConsolePrint(this.connectionToClient, "Local tag refreshed.", "green");
    }
  }
  ...
  {
    if (this.connectionToClient == null || !this.connectionToClient.isConnected)
      return;
  ...
  public void DisconnectClient(NetworkConnection conn, string message)
  {
    ...
    Timing.RunCoroutine(this._DisconnectAfterTimeout(conn), Segment.Update);
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator<float>) new CharacterClassManager.\u003C_DisconnectAfterTimeout\u003Ec__Iterator1() { conn = conn };
  }
  ...
  {
    if ((double) Vector3.Distance(this.transform.position, this.GetComponent<Escape>().worldPosition) >= (double) (this.GetComponent<Escape>().radius * 2))
      return;
    CharacterClassManager component = this.GetComponent<CharacterClassManager>();
    if (this.klasy[component.curClass].team == Team.CDP)
    {
      this.SetPlayersClass(8, this.gameObject);
      ++RoundSummary.escaped_ds;
    }
    if (this.klasy[component.curClass].team != Team.RSC)
      return;
    this.SetPlayersClass(4, this.gameObject);
  ...
  public void ApplyProperties()
  {
    ...
    Inventory component1 = this.GetComponent<Inventory>();
    PlyMovementSync component2 = this.GetComponent<PlyMovementSync>();
    try
    {
      this.GetComponent<FootstepSync>().SetLoundness(@class.team, @class.fullName.Contains("939"));
    }
    catch
    {
    }
    ...
    if (this.isLocalPlayer)
    {
      this.GetComponent<FirstPersonController>().isSCP = @class.team == Team.SCP;
      DiscordManager.singleton.ChangePreset(this.curClass);
      this.GetComponent<Radio>().UpdateClass();
      this.GetComponent<Handcuffs>().CallCmdTarget((GameObject) null);
      this.GetComponent<WeaponManager>().flashlightEnabled = true;
      this.GetComponent<Searching>().Init(@class.team == Team.SCP | @class.team == Team.RIP);
    }
      ...
      if (this.isLocalPlayer)
      {
        ...
        if (this.curClass != 2 || Radio.roundStarted)
        {
          if (this._wasAnytimeAlive)
            ...
            Object.FindObjectOfType<StartScreen>().PlayAnimation(this.curClass);
          this.GetComponent<HorrorSoundController>().horrorSoundSource.PlayOneShot(this.bell_dead);
        }
        this.GetComponent<PlayerStats>().maxHP = @class.maxHP;
    ...
    else
    {
      if (NetworkServer.active)
      {
        GameObject randomPosition = Object.FindObjectOfType<SpawnpointManager>().GetRandomPosition(this.curClass);
        if ((Object) randomPosition != (Object) null)
        {
          component2.SetPosition(randomPosition.transform.position);
          component2.SetRotation(randomPosition.transform.rotation.eulerAngles.y);
        }
        else
      ...
      if (this.isLocalPlayer)
      {
        this.GetComponent<Scp106PlayerScript>().SetDoors();
        component1.NetworkcurItem = -1;
        Object.FindObjectOfType<StartScreen>().PlayAnimation(this.curClass);
        if (!this.GetComponent<HorrorSoundController>().horrorSoundSource.isPlaying)
          this.GetComponent<HorrorSoundController>().horrorSoundSource.PlayOneShot(this.bell);
        this.Invoke("EnableFPC", 0.2f);
        this.GetComponent<Radio>().ResetPreset();
        this.GetComponent<Radio>().Invoke("ResetPreset", 2f);
        FirstPersonController component3 = this.GetComponent<FirstPersonController>();
        PlayerStats component4 = this.GetComponent<PlayerStats>();
        ...
        Object.FindObjectOfType<UserMainInterface>().lerpedHP = (float) maxHp;
    ...
    if (this.isLocalPlayer)
    {
      Object.FindObjectOfType<InventoryDisplay>().isSCP = this.curClass == 2 | @class.team == Team.SCP;
  ...
  public void RefreshPlyModel(int classID = -1)
  {
    ...
    if ((Object) this.myModel != (Object) null)
      Object.Destroy((Object) this.myModel);
    Class @class = this.klasy[classID >= 0 ? classID : this.curClass];
    if (@class.team != Team.RIP)
    {
      GameObject gameObject = Object.Instantiate<GameObject>(@class.model_player);
      ...
      if ((Object) this.myModel.GetComponent<Animator>() != (Object) null)
        this.GetComponent<AnimationController>().animator = this.myModel.GetComponent<Animator>();
      if (this.isLocalPlayer)
      {
        if ((Object) this.myModel.GetComponent<Renderer>() != (Object) null)
    ...
    this.GetComponent<CapsuleCollider>().enabled = @class.team != Team.RIP;
    if (!((Object) this.myModel != (Object) null))
      return;
  ...
  public void SetClassID(int id)
  {
    if (!this.IsVerified && id != 2)
      return;
    if (this.GetComponent<ServerRoles>().OverwatchEnabled && id != 2)
    {
      if (this.curClass == 2)
        return;
      id = 2;
  ...
  public void InstantiateRagdoll(int id)
  {
    if (id < 0)
      return;
    Class @class = this.klasy[this.curClass];
    GameObject gameObject = Object.Instantiate<GameObject>(@class.model_ragdoll);
    gameObject.transform.position = this.transform.position + @class.ragdoll_offset.position;
    gameObject.transform.rotation = Quaternion.Euler(this.transform.rotation.eulerAngles + @class.ragdoll_offset.rotation);
    gameObject.transform.localScale = @class.ragdoll_offset.scale;
  }

  public void SetRandomRoles()
  {
    this.GetComponent<MTFRespawn>();
    if (this.isLocalPlayer && this.isServer)
    {
      GameObject[] array = this.GetShuffledPlayerList().ToArray();
      this.GetComponent<RoundSummary>();
  ...
  {
    this.CallTargetDeathScreen(this.connectionToClient, this.GetComponent<PlayerStats>().lastHitInfo);
  }
  ...
  private void RunSmartClassPicker()
  {
    ...
    try
    {
      ...
      foreach (GameObject gameObject in shuffledPlayerList)
      {
        ...
        {
          NetworkConnection component1 = gameObject.GetComponent<NetworkConnection>();
          CharacterClassManager component2 = gameObject.GetComponent<CharacterClassManager>();
          str = "Getting Player ID";
          if (component1 == null && (Object) component2 == (Object) null)
          {
            shuffledPlayerList.Remove(gameObject);
            break;
          }
          string key = (component1 == null ? string.Empty : component1.address) + (!((Object) component2 != (Object) null) ? string.Empty : component2.SteamId);
      ...
      foreach (GameObject ply in shuffledPlayerList)
      {
        ...
        {
          NetworkConnection component1 = ply.GetComponent<NetworkConnection>();
          ...
          string playerUuid = (component1 == null ? string.Empty : component1.address) + (!((Object) component2 != (Object) null) ? string.Empty : component2.SteamId);
          ...
          {
            this.SetPlayersClass(mostLikelyClass, ply);
      ...
      foreach (GameObject ply in gameObjectList)
      {
        if (!((Object) ply == (Object) null))
        {
          if (availableClasses.Count > 0)
          {
            ...
            this.SetPlayersClass(classid, ply);
            availableClasses.Remove(classid);
          }
          else
            this.SetPlayersClass(2, ply);
        }
      }
  ...
  private void UpdateClassChances(int classChoice, int[] classChances)
  {
    ...
    for (int index = 0; index < classChances.Length; ++index)
    {
      ...
      classChances[index] = Mathf.Clamp(classChances[index], min, max);
    }
  }
  ...
  {
    // ISSUE: object of a compiler-generated type is created
    return (IEnumerator<float>) new CharacterClassManager.\u003CMakeSureToSetHP\u003Ec__Iterator2() { \u0024this = this };
  }
  ...
  public void CallCmdSendToken(string token)
  {
    ...
    else
    {
      ...
      writer.WritePackedUInt32((uint) CharacterClassManager.kCmdCmdSendToken);
      writer.Write(this.GetComponent<NetworkIdentity>().netId);
      writer.Write(token);
      this.SendCommandInternal(writer, 2, "CmdSendToken");
    }
  }
  ...
  public void CallCmdRequestContactEmail()
  {
    ...
    else
    {
      ...
      writer.Write((short) 0);
      writer.Write((short) 5);
      writer.WritePackedUInt32((uint) CharacterClassManager.kCmdCmdRequestContactEmail);
      writer.Write(this.GetComponent<NetworkIdentity>().netId);
      this.SendCommandInternal(writer, 2, "CmdRequestContactEmail");
    }
  }
  ...
  public void CallCmdRequestServerConfig()
  {
    ...
    else
    {
      ...
      writer.Write((short) 0);
      writer.Write((short) 5);
      writer.WritePackedUInt32((uint) CharacterClassManager.kCmdCmdRequestServerConfig);
      writer.Write(this.GetComponent<NetworkIdentity>().netId);
      this.SendCommandInternal(writer, 2, "CmdRequestServerConfig");
    }
  }
  ...
  public void CallCmdRequestServerGroups()
  {
    ...
    else
    {
      ...
      writer.Write((short) 0);
      writer.Write((short) 5);
      writer.WritePackedUInt32((uint) CharacterClassManager.kCmdCmdRequestServerGroups);
      writer.Write(this.GetComponent<NetworkIdentity>().netId);
      this.SendCommandInternal(writer, 2, "CmdRequestServerGroups");
    }
  }
  ...
  public void CallCmdRequestHideTag()
  {
    ...
    else
    {
      ...
      writer.Write((short) 0);
      writer.Write((short) 5);
      writer.WritePackedUInt32((uint) CharacterClassManager.kCmdCmdRequestHideTag);
      writer.Write(this.GetComponent<NetworkIdentity>().netId);
      this.SendCommandInternal(writer, 2, "CmdRequestHideTag");
    }
  }
  ...
  public void CallCmdRequestShowTag(bool global)
  {
    ...
    else
    {
      ...
      writer.Write((short) 0);
      writer.Write((short) 5);
      writer.WritePackedUInt32((uint) CharacterClassManager.kCmdCmdRequestShowTag);
      writer.Write(this.GetComponent<NetworkIdentity>().netId);
      writer.Write(global);
      this.SendCommandInternal(writer, 2, "CmdRequestShowTag");
    }
  }
  ...
  public void CallCmdConfirmDisconnect()
  {
    ...
    else
    {
      ...
      writer.Write((short) 0);
      writer.Write((short) 5);
      writer.WritePackedUInt32((uint) CharacterClassManager.kCmdCmdConfirmDisconnect);
      writer.Write(this.GetComponent<NetworkIdentity>().netId);
      this.SendCommandInternal(writer, 2, "CmdConfirmDisconnect");
    }
  }
  ...
  public void CallCmdRegisterEscape()
  {
    ...
    else
    {
      ...
      writer.Write((short) 0);
      writer.Write((short) 5);
      writer.WritePackedUInt32((uint) CharacterClassManager.kCmdCmdRegisterEscape);
      writer.Write(this.GetComponent<NetworkIdentity>().netId);
      this.SendCommandInternal(writer, 2, "CmdRegisterEscape");
    }
  }
  ...
  public void CallCmdRequestDeathScreen()
  {
    ...
    else
    {
      ...
      writer.Write((short) 0);
      writer.Write((short) 5);
      writer.WritePackedUInt32((uint) CharacterClassManager.kCmdCmdRequestDeathScreen);
      writer.Write(this.GetComponent<NetworkIdentity>().netId);
      this.SendCommandInternal(writer, 0, "CmdRequestDeathScreen");
    }
  }
  ...
  public void CallRpcPlaceBlood(Vector3 pos, int type, float f)
  {
    ...
    else
    {
      ...
      writer.WritePackedUInt32((uint) CharacterClassManager.kRpcRpcPlaceBlood);
      writer.Write(this.GetComponent<NetworkIdentity>().netId);
      writer.Write(pos);
      writer.WritePackedUInt32((uint) type);
      writer.Write(f);
      this.SendRPCInternal(writer, 0, "RpcPlaceBlood");
    }
  }
  ...
  public void CallTargetConsolePrint(NetworkConnection connection, string text, string color)
  {
    ...
    else
    {
      ...
      writer.Write((short) 0);
      writer.Write((short) 2);
      writer.WritePackedUInt32((uint) CharacterClassManager.kTargetRpcTargetConsolePrint);
      writer.Write(this.GetComponent<NetworkIdentity>().netId);
      writer.Write(text);
      writer.Write(color);
      this.SendTargetRPCInternal(connection, writer, 2, "TargetConsolePrint");
    }
  }
  ...
  public void CallTargetSetDisconnectError(NetworkConnection conn, string message)
  {
    ...
    else
    {
      ...
      writer.Write((short) 0);
      writer.Write((short) 2);
      writer.WritePackedUInt32((uint) CharacterClassManager.kTargetRpcTargetSetDisconnectError);
      writer.Write(this.GetComponent<NetworkIdentity>().netId);
      writer.Write(message);
      this.SendTargetRPCInternal(conn, writer, 2, "TargetSetDisconnectError");
    }
  }
  ...
  {
    NetworkBehaviour.RegisterCommandDelegate(typeof (CharacterClassManager), CharacterClassManager.kCmdCmdSendToken, new NetworkBehaviour.CmdDelegate(CharacterClassManager.InvokeCmdCmdSendToken));
    CharacterClassManager.kCmdCmdRequestContactEmail = 2054299309;
    NetworkBehaviour.RegisterCommandDelegate(typeof (CharacterClassManager), CharacterClassManager.kCmdCmdRequestContactEmail, new NetworkBehaviour.CmdDelegate(CharacterClassManager.InvokeCmdCmdRequestContactEmail));
    CharacterClassManager.kCmdCmdRequestServerConfig = -2046741578;
    NetworkBehaviour.RegisterCommandDelegate(typeof (CharacterClassManager), CharacterClassManager.kCmdCmdRequestServerConfig, new NetworkBehaviour.CmdDelegate(CharacterClassManager.InvokeCmdCmdRequestServerConfig));
    CharacterClassManager.kCmdCmdRequestServerGroups = -1929409976;
    NetworkBehaviour.RegisterCommandDelegate(typeof (CharacterClassManager), CharacterClassManager.kCmdCmdRequestServerGroups, new NetworkBehaviour.CmdDelegate(CharacterClassManager.InvokeCmdCmdRequestServerGroups));
    CharacterClassManager.kCmdCmdRequestHideTag = -1886885625;
    NetworkBehaviour.RegisterCommandDelegate(typeof (CharacterClassManager), CharacterClassManager.kCmdCmdRequestHideTag, new NetworkBehaviour.CmdDelegate(CharacterClassManager.InvokeCmdCmdRequestHideTag));
    CharacterClassManager.kCmdCmdRequestShowTag = -732213908;
    NetworkBehaviour.RegisterCommandDelegate(typeof (CharacterClassManager), CharacterClassManager.kCmdCmdRequestShowTag, new NetworkBehaviour.CmdDelegate(CharacterClassManager.InvokeCmdCmdRequestShowTag));
    ...
    NetworkBehaviour.RegisterCommandDelegate(typeof (CharacterClassManager), CharacterClassManager.kCmdCmdConfirmDisconnect, new NetworkBehaviour.CmdDelegate(CharacterClassManager.InvokeCmdCmdConfirmDisconnect));
    ...
    NetworkBehaviour.RegisterCommandDelegate(typeof (CharacterClassManager), CharacterClassManager.kCmdCmdRequestDeathScreen, new NetworkBehaviour.CmdDelegate(CharacterClassManager.InvokeCmdCmdRequestDeathScreen));
    CharacterClassManager.kRpcRpcPlaceBlood = 1372291111;
    NetworkBehaviour.RegisterRpcDelegate(typeof (CharacterClassManager), CharacterClassManager.kRpcRpcPlaceBlood, new NetworkBehaviour.CmdDelegate(CharacterClassManager.InvokeRpcRpcPlaceBlood));
    CharacterClassManager.kTargetRpcTargetConsolePrint = -558403607;
    NetworkBehaviour.RegisterRpcDelegate(typeof (CharacterClassManager), CharacterClassManager.kTargetRpcTargetConsolePrint, new NetworkBehaviour.CmdDelegate(CharacterClassManager.InvokeRpcTargetConsolePrint));
    CharacterClassManager.kTargetRpcTargetSetDisconnectError = -2047672291;
    NetworkBehaviour.RegisterRpcDelegate(typeof (CharacterClassManager), CharacterClassManager.kTargetRpcTargetSetDisconnectError, new NetworkBehaviour.CmdDelegate(CharacterClassManager.InvokeRpcTargetSetDisconnectError));
    CharacterClassManager.kTargetRpcTargetDeathScreen = -520196787;
    NetworkBehaviour.RegisterRpcDelegate(typeof (CharacterClassManager), CharacterClassManager.kTargetRpcTargetDeathScreen, new NetworkBehaviour.CmdDelegate(CharacterClassManager.InvokeRpcTargetDeathScreen));
