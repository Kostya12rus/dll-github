...
namespace UnityEngine.PostProcessing
{
  ...
  {
    private readonly RenderTargetIdentifier[] m_MRT = new RenderTargetIdentifier[2]{ (RenderTargetIdentifier) BuiltinRenderTextureType.GBuffer0, (RenderTargetIdentifier) BuiltinRenderTextureType.CameraTarget };
    ...
    {
      return this.ambientOnlySupported && !this.context.profile.debugViews.IsModeActive(BuiltinDebugViewsModel.Mode.AmbientOcclusion) ? CameraEvent.BeforeReflections : CameraEvent.BeforeImageEffectsOpaque;
    }
    ...
    public override void PopulateCommandBuffer(CommandBuffer cb)
    {
      ...
      cb.Blit((RenderTargetIdentifier) occlusionTexture1, (RenderTargetIdentifier) occlusionTexture2, material, this.occlusionSource != AmbientOcclusionComponent.OcclusionSource.GBuffer ? 3 : 4);
