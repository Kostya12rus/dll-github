...
namespace UnityEngine.PostProcessing
{
  public sealed class ColorGradingComponent : PostProcessingComponentRenderTexture<ColorGradingModel>
  {
    ...
    private static Color NormalizeColor(Color c)
    {
      ...
      return new Color() { r = c.r / a, g = c.g / a, b = c.b / a, a = c.a };
    }
    ...
    public static Vector3 GetLiftValue(Color lift)
    {
      ...
      return ColorGradingComponent.ClampVector(new Vector3((float) (((double) color.r - (double) num) * 0.100000001490116) + lift.a, (float) (((double) color.g - (double) num) * 0.100000001490116) + lift.a, (float) (((double) color.b - (double) num) * 0.100000001490116) + lift.a), -1f, 1f);
    }
    ...
    public static Vector3 GetGammaValue(Color gamma)
    {
      ...
      float num = (float) (((double) color.r + (double) color.g + (double) color.b) / 3.0);
      gamma.a *= (double) gamma.a >= 0.0 ? 5f : 0.8f;
      return ColorGradingComponent.ClampVector(new Vector3(1f / Mathf.Max(0.01f, Mathf.Pow(2f, (float) (((double) color.r - (double) num) * 0.5)) + gamma.a), 1f / Mathf.Max(0.01f, Mathf.Pow(2f, (float) (((double) color.g - (double) num) * 0.5)) + gamma.a), 1f / Mathf.Max(0.01f, Mathf.Pow(2f, (float) (((double) color.b - (double) num) * 0.5)) + gamma.a)), 0.0f, 5f);
    }
    ...
    public static Vector3 GetGainValue(Color gain)
    {
      ...
      float num = (float) (((double) color.r + (double) color.g + (double) color.b) / 3.0);
      gain.a *= (double) gain.a <= 0.0 ? 1f : 3f;
    ...
    public static Vector3 GetSlopeValue(Color slope)
    {
      ...
      float num = (float) (((double) color.r + (double) color.g + (double) color.b) / 3.0);
      slope.a *= 0.5f;
      return ColorGradingComponent.ClampVector(new Vector3((float) (((double) color.r - (double) num) * 0.100000001490116 + (double) slope.a + 1.0), (float) (((double) color.g - (double) num) * 0.100000001490116 + (double) slope.a + 1.0), (float) (((double) color.b - (double) num) * 0.100000001490116 + (double) slope.a + 1.0)), 0.0f, 2f);
    }
    ...
    public static Vector3 GetPowerValue(Color power)
    {
      ...
      float num = (float) (((double) color.r + (double) color.g + (double) color.b) / 3.0);
      power.a *= 0.5f;
      return ColorGradingComponent.ClampVector(new Vector3(1f / Mathf.Max(0.01f, (float) (((double) color.r - (double) num) * 0.100000001490116 + (double) power.a + 1.0)), 1f / Mathf.Max(0.01f, (float) (((double) color.g - (double) num) * 0.100000001490116 + (double) power.a + 1.0)), 1f / Mathf.Max(0.01f, (float) (((double) color.b - (double) num) * 0.100000001490116 + (double) power.a + 1.0))), 0.5f, 2.5f);
    }
    ...
    public static Vector3 GetOffsetValue(Color offset)
    {
      ...
      float num = (float) (((double) color.r + (double) color.g + (double) color.b) / 3.0);
      offset.a *= 0.5f;
      return ColorGradingComponent.ClampVector(new Vector3((float) (((double) color.r - (double) num) * 0.0500000007450581) + offset.a, (float) (((double) color.g - (double) num) * 0.0500000007450581) + offset.a, (float) (((double) color.b - (double) num) * 0.0500000007450581) + offset.a), -0.8f, 0.8f);
    }
    ...
    {
      return SystemInfo.SupportsTextureFormat(TextureFormat.RGBAHalf) ? TextureFormat.RGBAHalf : TextureFormat.RGBA32;
    }
    ...
    {
      if ((Object) lut != (Object) null && lut.IsCreated())
    ...
    {
      return SystemInfo.SupportsRenderTextureFormat(RenderTextureFormat.ARGBHalf) ? RenderTextureFormat.ARGBHalf : RenderTextureFormat.ARGB32;
    }
    ...
    private void GenerateLut()
    {
      ...
      if (!this.IsLogLutValid(this.model.bakedLut))
      {
        ...
        renderTexture1.name = "Color Grading Log LUT";
