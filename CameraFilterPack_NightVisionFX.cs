...
public class CameraFilterPack_NightVisionFX : MonoBehaviour
{
  ...
  private void Update()
  {
    ...
    float[] numArray1 = new float[12]{ 0.757f, 0.098f, 0.458f, -2.49f, 0.559f, -0.298f, 1.202f, 0.515f, 1f, 0.0f, 0.0f, 0.0f };
    float[] numArray2 = new float[12]{ 0.2f, 0.202f, 0.68f, -1.49f, 0.084f, -0.019f, 2f, 0.166f, 550f * (float) Math.PI / 887f, -0.1f, 0.15f, -0.07f };
    float[] numArray3 = new float[12]{ 1.45f, 0.01f, 0.112f, -0.07f, 0.111f, -0.077f, 0.071f, 0.0f, 0.245f, 0.0f, 0.0f, 0.0f };
    float[] numArray4 = new float[12]{ 0.779f, 0.185f, 0.706f, 1.21f, 0.24f, 0.138f, 2f, 0.07f, 1.224f, -0.21f, -0.34f, 0.0f };
    float[] numArray5 = new float[12]{ 0.2f, 0.028f, 0.706f, 1.21f, 0.397f, -0.24f, 2f, 0.298f, 1.224f, -0.08f, 0.48f, -0.57f };
    float[] numArray6 = new float[12]{ 0.2f, 0.159f, 0.622f, -2.28f, 0.409f, -0.24f, 0.166f, 0.028f, 2f, -0.08f, 0.22f, 0.57f };
    float[] numArray7 = new float[12]{ 2f, 0.054f, 1f, -2.28f, 0.409f, -1f, 2f, 0.187f, 0.241f, 0.0f, 1.58f, 0.21f };
    float[] numArray8 = new float[12]{ 2f, 0.054f, 1f, 1.28f, 0.409f, -1f, 0.41f, 0.656f, 0.427f, 0.95f, -0.35f, 1.41f };
    float[] numArray9 = new float[12]{ 2f, 0.281f, 0.156f, 1.85f, 0.709f, -1f, 0.41f, 0.109f, 0.34f, 0.95f, 0.36f, -0.14f };
    float[] numArray10 = new float[12]{ 0.905f, 0.281f, 0.156f, 1.85f, 0.558f, -275f * (float) Math.PI / 887f, 1.639f, 0.252f, 1.074f, 0.46f, 0.95f, 0.58f };
