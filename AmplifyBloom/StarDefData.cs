...
namespace AmplifyBloom
{
  ...
  public class StarDefData
  {
    ...
    public StarDefData(StarLibType starType, string starName, int starLinesCount, int passCount, float sampleLength, float attenuation, float inclination, float rotation, float longAttenuation = 0.0f, float customIncrement = -1f)
    {
